...
public class CameraSource {
    ...
    /**
     * Callback interfaces used to signal the moment of actual image capture.
     */
    ...
    /**
     * Callback interfaces used to supply image data from a photo capture.
     */
    ...
    /**
     * Callback interfaces used to notify on completion of camera auto focus.
     */
    ...
    /**
     * Callback interfaces used to notify on auto focus start and stop.
     * <p/>
        ...
        synchronized (mCameraLock) {
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    // wasn't introduced until Honeycomb.  Since the interfaces cannot use a
