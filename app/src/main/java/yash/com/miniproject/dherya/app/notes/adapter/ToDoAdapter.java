package yash.com.miniproject.dherya.app.notes.adapter;
...
import yash.com.miniproject.dherya.app.notes.AddNewTask;
...
public class ToDoAdapter extends RecyclerView.Adapter<ToDoAdapter.ViewHolder> {
    ...
    public ToDoAdapter(DatabaseHandler db, ToDoFragment toDoFragment) {
        this.db = db;
    ...
    public void editItem(int position) {
        ...
        fragment.show(toDoFragment.requireActivity().getSupportFragmentManager(), AddNewTask.TAG);
    }
