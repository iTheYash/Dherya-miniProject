...
public class ReminderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitledit = (EditText) findViewById(R.id.textTask);
        ...
        mSubmitbtn = (Button) findViewById(R.id.btnSave);
    ...
    private void setAlarm(String text, String date, String time) {
        ...
        Intent intentBack = new Intent(getApplicationContext(), NotessFragment.class);                //this intent will be called once the setting alaram is completes
