...
import yash.com.miniproject.dherya.app.activities.ImageCropperActivity;
import yash.com.miniproject.dherya.app.utils.ImageUtils;
import yash.com.miniproject.dherya.app.utils.NumberInputFilter;
import yash.com.miniproject.dherya.app.utils.PermissionUtils;
...
import yash.com.miniproject.dherya.exceptions.CouldNotUpdateDataException;
...
public class CreateOrEditExpenseDialogFragment extends AppCompatDialogFragment implements View.OnClickListener {
    ...
    private void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(getActivity().getPackageManager()) != null) {
            ...
            if(tempFile != null) {
                try {
                    imageUri = FileProvider.getUriForFile(getContext(), "yash.com.miniproject.dherya.fileprovider", tempFile);
